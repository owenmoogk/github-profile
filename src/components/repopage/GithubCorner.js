...
export default function GithubCorner(props) {
	...
	function loadedPage() {
		...
		return (
			<div id='cornerImage'>
				<a href={props.href} className="github-corner" target={props.newTab ? '_blank' : ''} rel='noreferrer'>
					<svg width={props.size} height={props.size} viewBox="0 0 250 250" style={{
						fill: props.backgroundColor,
						color: props.color,
						transform: props.align === 'left' ? 'scale(-1, 1)' : ''
					}}>
